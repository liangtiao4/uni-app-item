...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _data = __webpack_require__(/*! ./data.js */ 14);
...
var unused = {
  ...
  getters: {
    ...
    // 购物车选中总数量
    totalCount: function totalCount(_ref4) {var cartList = _ref4.cartList;
      return cartList.reduce(function (total, item) {
        return item.isCheck ? total + item.count : total;
      }, 0);
    },
    // 购物车全选
    isAll: function isAll(_ref5) {var cartList = _ref5.cartList;
